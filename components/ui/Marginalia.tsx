 ...
 *
 * THE NOTES REACT TO THE CURSOR — but the motion is not driven here.
 * components/ui/CursorField.tsx runs ONE loop for the whole page and moves
 * every .marginalia and .cut-out-drift element. A loop per Marginalia instance
 * meant the homepage ran several in parallel, each doing its own layout reads.
 *
 * This component therefore stays a server component: it only places the notes.
 */
